...
const translations = {
    id: {
        ...
        "nav-gallery": "Galeri",
        "nav-contact": "Contact",
        "hero-title": "Agen Terpercaya untuk <span class=\"text-transparent bg-clip-text bg-gradient-to-l from-slate-500 via-blue-950 to-indigo-900 bg-[length:200%_auto] animate-gradient\">Mesin Inspeksi, </span> <span class=\"text-slate-900 font-extrabold\"></span> <span class=\"text-transparent bg-clip-text bg-gradient-to-l from-blue-900 via-slate-600 to-cyan-500 bg-[length:200%_auto] animate-gradient\">Sistem Magnet Neodynium <br> &amp; Jasa Kalibrasi</span>",
    ...
    en: {
        ...
        "nav-gallery": "Gallery",
        "nav-contact": "Contact",
        "hero-title": "Trusted Agent for <span class=\"text-transparent bg-clip-text bg-gradient-to-l from-slate-500 via-blue-950 to-indigo-900 bg-[length:200%_auto] animate-gradient\">Inspection Machines, </span> <span class=\"text-slate-900 font-extrabold\"></span> <span class=\"text-transparent bg-clip-text bg-gradient-to-l from-blue-900 via-slate-600 to-cyan-500 bg-[length:200%_auto] animate-gradient\">Neodymium Magnet Systems &amp; Calibration Services</span>",
